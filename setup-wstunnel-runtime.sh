...
APP_DOWNLOAD_URL="https://github.com/erebe/wstunnel/releases/download/${VERSION}/${APP_NAME}_${APP_VERSION}_${OS}_${ARCH}.tar.gz"
...
echo " "
echo " wstunnel docs :  https://github.com/erebe/wstunnel "
echo " "
