...
set "LDFLAGS=/WHOLEARCHIVE:libcmt.lib /WHOLEARCHIVE:libucrt.lib /VERBOSE:LIB	/FORCE:MULTIPLE /NODEFAULTLIB:msvcrt.lib /NODEFAULTLIB:libcmtd.lib /NODEFAULTLIB:msvcrtd.lib /DEFAULTLIB:libcmt.lib  /DEFAULTLIB:libucrt.lib /DEFAULTLIB:libvcruntime.lib	/NODEFAULTLIB:libucrtd.lib  /NODEFAULTLIB:ucrt.lib /NODEFAULTLIB:ucrtd.lib	"

rem /VERBOSE /WHOLEARCHIVE
