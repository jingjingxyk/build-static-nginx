...
set "LDFLAGS= /WHOLEARCHIVE:libucrt.lib /VERBOSE:LIB	 /NODEFAULTLIB:msvcrt.lib /NODEFAULTLIB:libcmtd.lib /NODEFAULTLIB:msvcrtd.lib /NODEFAULTLIB:libcmt.lib  /DEFAULTLIB:libucrt.lib /DEFAULTLIB:libvcruntime.lib	/NODEFAULTLIB:libucrtd.lib  /NODEFAULTLIB:ucrt.lib /NODEFAULTLIB:ucrtd.lib	"

rem /VERBOSE /WHOLEARCHIVE /FORCE:MULTIPLE /WHOLEARCHIVE:libcmt.lib
